...
export function zKProofEngineFromJSON(object: any): ZKProofEngine {
  switch (object) {
    ...
    case 2:
    case "ZK_ENGINE_BARRETENBERG":
      return ZKProofEngine.ZK_ENGINE_BARRETENBERG;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function zKProofEngineToJSON(object: ZKProofEngine): string {
  switch (object) {
    ...
    case ZKProofEngine.ZK_ENGINE_BARRETENBERG:
      return "ZK_ENGINE_BARRETENBERG";
