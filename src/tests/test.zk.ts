  ...
  it("should correctly redact blocks", async () => {
    const vectors: RedactionTestVector[] = [
      {
        input: ["hell", "o world"],
        output: ["h***", "* world"],
        redactions: [{ fromIndex: 1, toIndex: 5 }],
      },
      {
        input: ["hell", "o world"],
        output: [
        ...
        redactions: [{ fromIndex: 0, toIndex: 5 }],
      },
      {
        input: ["hello", "how", "do", "you", "do"],
        output: ["he**o", "d*", "y*u", "do"],
        redactions: [
    ...
    for (const { input, output, redactions } of vectors) {
      ...
      for (const [i, element] of output.entries()) {
        expect(uint8ArrayToStr(realOutput[i].redactedPlaintext)).toEqual(
          element
        );
      }
    }
    ...
    const vectors: RedactionTestVector[] = [
      {
        ...
        redactions: [{ fromIndex: 1, toIndex: 5, hash: "oprf" }],
      },
      {
        input: ["hell", "o world"],
        output: [
        ...
        redactions: [{ fromIndex: 0, toIndex: 5, hash: "oprf" }],
      },
    ];
...
describe.each(ZK_CIPHER_SUITES)(
        ...
        const vectors = [
          {
            ...
            redactions: [{ fromIndex: 23, toIndex: 35 }],
          },
          {
            plaintext: `lorem ipsum dolor sit amet, consectetur adipiscing elit,
				...
				id est laborum`,
            redactions: [{ fromIndex: 5, toIndex: 15 }],
          },
        ];
